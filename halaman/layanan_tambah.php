...
<form action="layanan_act.php" method="post" enctype="multipart/form-data">
    ...
    <label>Kode Penyelenggaraan:</label>
        ...
        ?>
            <option value="<?php echo $d['z_idpenyelenggaraan']; ?>"><?php echo $d['z_kodepenyelenggaraan'].' - '.$d['z_namapenyelenggaraan']; ?></option>
        <?php } ?>
        </select>
    </div>
    <div class="form-group">
    <label>Kode Layanan:</label>
        <input type="text" class="form-control" name="kode" onkeyup="this.value = this.value.toUpperCase()" required="required" placeholder="Masukkan Kode Layanan..." maxlength="25">
        <small class="text-muted">* Isi - Jika Tidak Ada Isinya</small>
    </div>
    <div class="form-group">
    <label>Nama Layanan:</label>
        <input type="text" class="form-control" name="nama" required="required" placeholder="Masukkan Nama Layanan..." maxlength="100">
        <small class="text-muted">* Isi - Jika Tidak Ada Isinya</small>
    </div>
    <div class="form-group">
    ...
    <label>Keterangan:</label>
        <textarea class="form-control" name="ket" rows="3" placeholder="Masukkan Keterangan Layanan..."></textarea>
        <small class="text-muted">* Jangan Diisi Jika Tidak Ada Isinya</small>
    </div>
