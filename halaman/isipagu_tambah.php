...
<section class="content-header">
    <h1>
        PAGU
        <small>Tambah PAGU Baru</small>
    </h1>
    <ol class="breadcrumb">
        <li><a href="index.php"><i class="fa fa-dashboard"></i> Beranda</a></li>
        <li class="active">Tambah PAGU Baru</li>
    </ol>
</section>
...
<section class="col-lg-6 col-lg-offset-3">       
    ...
    <div class="box-header">
        <h3 class="box-title">Tambah PAGU:</h3>
        <a href="isipagu.php" class="btn btn-info btn-sm pull-right"><i class="fa fa-reply"></i> &nbsp Kembali</a> 
    </div>
    <div class="box-body">
<form action="isipagu_act.php" method="post" enctype="multipart/form-data">
    ...
    <label>Kode Layanan:</label>
        <input type="hidden" class="form-control" name="kode05" id="kode05" maxlength="25" readonly>
    ...
    <label>Kode PAGU:</label>
        <input type="text" class="form-control" name="kode" onkeyup="this.value = this.value.toUpperCase()" required="required" placeholder="Masukkan Kode PAGU..." maxlength="25">
        <small class="text-muted">* Isi - Jika Tidak Ada Isinya</small>
    </div>
    <div class="form-group">
    <label>Nama PAGU:</label>
        <input type="text" class="form-control" name="nama" required="required" placeholder="Masukkan Nama PAGU..." maxlength="100">
        <small class="text-muted">* Isi - Jika Tidak Ada Isinya</small>
    </div>
    <div class="form-group">
    <label>Volume Satuan:</label>
        <input type="number" class="form-control" name="vol" id="vol" onkeyup="plus()" placeholder="Masukkan Volume Satuan..." maxlength="5">
    ...
    <label>Harga Satuan:</label>
        <input type="number" class="form-control" name="hars" id="hars" onkeyup="plus()" placeholder="Masukkan Harga Satuan..." maxlength="25">
        <small class="text-muted">* Isi 0 Jika Tidak Ada Isinya</small>
    </div>
    <div class="form-group">
    <label>PAGU:</label>
        <input type="number" class="form-control" name="pagu" id="pagu" maxlength="25" placeholder="Rp. 0,-" readonly>
    </div>
    <div class="form-group">
    <label>Keterangan:</label>
        <textarea class="form-control" name="ket" rows="3" placeholder="Masukkan Keterangan PAGU..."></textarea>
        <small class="text-muted">* Jangan Diisi Jika Tidak Ada Isinya</small>
    </div>
