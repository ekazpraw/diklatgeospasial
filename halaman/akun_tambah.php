...
<section class="col-lg-6 col-lg-offset-3">       
    ...
    <div class="box-header">
        ...
        <a href="akun.php" class="btn btn-info btn-sm pull-right"><i class="fa fa-reply"></i> &nbsp Kembali</a> 
    </div>
    <div class="box-body">
<form action="akun_act.php" method="post" enctype="multipart/form-data">
    ...
    <label>Kode Sub Komponen:</label>
        ...
        ?>
            <option value="<?php echo $d['z_idsubkomponen']; ?>"><?php echo $d['z_kodesubkomponen'].' - '.$d['z_namasubkomponen']; ?></option>
        <?php } ?>
        </select>
    </div>
    <div class="form-group">
    <label>Kode Akun:</label>
        <input type="text" class="form-control" name="kode" onkeyup="this.value = this.value.toUpperCase()" required="required" placeholder="Masukkan Kode Akun..." maxlength="25">
        <small class="text-muted">* Isi - Jika Tidak Ada Isinya</small>
    </div>
    <div class="form-group">
    <label>Nama Akun:</label>
        <input type="text" class="form-control" name="nama" required="required" placeholder="Masukkan Nama Akun..." maxlength="100">
        <small class="text-muted">* Isi - Jika Tidak Ada Isinya</small>
    </div>
    <div class="form-group">
    ...
    <label>Keterangan:</label>
        <textarea class="form-control" name="ket" rows="3" placeholder="Masukkan Keterangan Akun..."></textarea>
        <small class="text-muted">* Jangan Diisi Jika Tidak Ada Isinya</small>
    </div>
